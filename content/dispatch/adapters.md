...
| commandcode | 0.41.1 | `commandcode -p '<prompt>' --skip-onboarding` — file READS are sandboxed to the workspace: dispatch files must live INSIDE the repo (e.g. .svp/dispatch/) | 46s | own PID | stdout stream |
