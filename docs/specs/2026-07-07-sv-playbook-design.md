...
| D26 | Safety-rail package: schema user_version with self-healing rebuild, rotating store backups, no-dead-ends principle | A worker stranded by a schema mismatch deleted the DB; day-1 telemetry lost | Prose prohibitions alone (proven insufficient the same day they were written) |
