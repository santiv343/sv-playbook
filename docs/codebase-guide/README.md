...
3. `flows/flow-03-packet-lifecycle.md` — ciclo de vida de un packet — *pendiente*
...
**Etapa actual: 3 — Persistencia y store.** Completada, ver `flows/flow-02-store-persistence.md`.
